        ...
        <div className="container hero-grid">
          <div className="hero-copy">
            {presentation.isPending && (
              <div className="hero-loading" role="status">
                <h1 tabIndex={-1}>Loading introduction</h1>
            ...
            {presentation.isError && (
              <div className="inline-state" role="alert">
                <h1 tabIndex={-1}>The introduction couldn’t be loaded.</h1>
                <p>The rest of the site remains available.</p>
                <button
                  className="button button-primary"
                  onClick={() => void presentation.refetch()}
                >
                  Try again
                </button>
              </div>
            ...
            {profile && (
              <>
                ...
                <p className="lede">{profile.shortSummary ?? profile.biography}</p>
              </>
            )}
            <div className="actions">
              <Link className="button button-primary" to="/presentation">
                Meet the engineer →
              </Link>
              {/* Blog action retained for later: <Link className="button" to="/articles">Read the articles</Link> */}
            </div>
          </div>
